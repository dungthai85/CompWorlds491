...
Background.prototype.draw = function() {
  ...
  if (
    MAIN_MENU &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 610 &&
    this.game.mouseXY.x <= 765 &&
    this.game.mouseXY.y >= 502 &&
    this.game.mouseXY.y <= 555
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/EasyText.png"),
      584,
      481,
      200,
      100
  ...
  if (
    MAIN_MENU &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 602 &&
    this.game.mouseXY.x <= 863 &&
    this.game.mouseXY.y >= 579 &&
    this.game.mouseXY.y <= 629
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/MediumText.png"),
      583,
      551,
      300,
      100
  ...
  if (
    MAIN_MENU &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 603 &&
    this.game.mouseXY.x <= 777 &&
    this.game.mouseXY.y >= 649 &&
    this.game.mouseXY.y <= 699
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/HardText.png"),
      591,
      620,
      200,
      100
  ...
  if (
    MAIN_MENU &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 614 &&
    this.game.mouseXY.x <= 881 &&
    this.game.mouseXY.y >= 711 &&
    this.game.mouseXY.y <= 771
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/TutorialText.png"),
      601,
      690,
      300,
      100
  ...
  if (
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 1280 &&
    this.game.mouseXY.x <= 1406 &&
    this.game.mouseXY.y >= 751 &&
    this.game.mouseXY.y <= 780
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/SoundText.png"),
      1272,
      739,
      140,
      50
  ...
  if (
    !MAIN_MENU &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 20 &&
    this.game.mouseXY.x <= 182 &&
    this.game.mouseXY.y >= 12 &&
    this.game.mouseXY.y <= 64
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/BackText.png"),
      18,
      1,
      180,
      80
  ...
  if (
    SELECT_MENU &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 650 &&
    this.game.mouseXY.x <= 790 &&
    this.game.mouseXY.y >= 685 &&
    this.game.mouseXY.y <= 775
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/ok1.png"),
      642,
      685,
      154,
      95
  ...
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsNoDamage1.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsNoDamage2.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsNoDamage3.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsNoDamage4.png"),
      0,
      0
    );
  }
  ...
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsLeftDamage1.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsLeftDamage2.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsLeftDamage3.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsLeftDamage4.png"),
      0,
      0
    );
  }
  ...
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsRightDamage1.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsRightDamage2.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsRightDamage3.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsRightDamage4.png"),
      0,
      0
    );
  }
  ...
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsDoubleDamage1.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsDoubleDamage2.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsDoubleDamage3.png"),
      0,
      0
    );
  }
  if (
    ...
    this.ctx.drawImage(
      AM.getAsset("./img/Background/LightsDoubleDamage4.png"),
      0,
      0
    );
  }

  // in game draw head icon here
  if (this.inGame) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/" + UNIT_CONTROL_CHARACTER[0] + "Icon.png"),
      430,
      655
    );
    this.ctx.drawImage(
      AM.getAsset("./img/Background/" + UNIT_CONTROL_CHARACTER[1] + "Icon.png"),
      550,
      655
    );
    this.ctx.drawImage(
      AM.getAsset("./img/Background/" + UNIT_CONTROL_CHARACTER[2] + "Icon.png"),
      670,
      655
    );
    this.ctx.drawImage(
      AM.getAsset("./img/Background/" + UNIT_CONTROL_CHARACTER[3] + "Icon.png"),
      790,
      655
    );
    this.ctx.drawImage(
      AM.getAsset("./img/Background/FireballIcon.png"),
      915,
      655
    );
  }
  ...
  if (
    WIN_LEVEL &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 490 &&
    this.game.mouseXY.x <= 920 &&
    this.game.mouseXY.y >= 460 &&
    this.game.mouseXY.y <= 530
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/NextLevel1.png"),
      500,
      450
    );
  }
  ...
  if (
    (GAME_OVER || WIN_GAME) &&
    this.game.mouseXY != null &&
    this.game.mouseXY.x >= 480 &&
    this.game.mouseXY.x <= 890 &&
    this.game.mouseXY.y >= 510 &&
    this.game.mouseXY.y <= 580
  ) {
    this.ctx.drawImage(
      AM.getAsset("./img/Background/PlayAgain1.png"),
      480,
      500
    );
  }
...
Background.prototype.update = function() {
  ...
  if (
    WIN_LEVEL &&
    this.game.menu.clicked &&
    this.game.menu.id === "NextLevel"
  ) {
    this.level++;
    this.noDamage();
    this.addentity();
    ...
    for (var i = 0; i < len; i++) {
      ...
      if (entity.name === "redhp") {
        if (entity.half || entity.quarter) {
          if (this.level === 1)
            this.spritesheet = AM.getAsset(
              "./img/Background/Map 1/LeftDamage.png"
            );
          else if (this.level === 2)
            this.spritesheet = AM.getAsset(
              "./img/Background/Map 2/LeftDamage.png"
            );
          else if (this.level === 3)
            this.spritesheet = AM.getAsset(
              "./img/Background/Map 3/LeftDamage.png"
            );
          this.damage = "leftDamage";
          temp++;
        }
      ...
      if (entity.name === "bluehp") {
        if (entity.half || entity.quarter) {
          ...
          if (this.level === 1)
            this.spritesheet = AM.getAsset(
              "./img/Background/Map 1/RightDamage.png"
            );
          else if (this.level === 2)
            this.spritesheet = AM.getAsset(
              "./img/Background/Map 2/RightDamage.png"
            );
          else if (this.level === 3)
            this.spritesheet = AM.getAsset(
              "./img/Background/Map 3/RightDamage.png"
            );
          this.damage = "rightDamage";
        }
        if (entity.hpbar <= 0) {
      ...
      if (temp === 2) {
        if (this.level === 1)
          this.spritesheet = AM.getAsset(
            "./img/Background/Map 1/DoubleDamage.png"
          );
        else if (this.level === 2)
          this.spritesheet = AM.getAsset(
            "./img/Background/Map 2/DoubleDamage.png"
          );
        else if (this.level === 3)
          this.spritesheet = AM.getAsset(
            "./img/Background/Map 3/DoubleDamage.png"
          );
        this.damage = "doubleDamage";
      }
    }
...
Background.prototype.addentity = function() {
...
Background.prototype.noDamage = function() {
  if (this.level === 1) {
