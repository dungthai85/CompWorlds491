function EnemyUnit(game, ENTITY_NAME, POSITION, LEVEL) {
  ...
  if (ENEMY.TYPE === "Boss") {
    this.walk_animation = new MyAnimation(
      ENEMY.sprite_sheet,
      0,
      0,
      400,
    ...
    this.attack_animation = new MyAnimation(
      ENEMY.sprite_sheet,
      0,
      400,
      400,
    ...
    this.hurt_animation = new MyAnimation(
      ENEMY.sprite_sheet,
      0,
      800,
      400,
    ...
    this.dead_animation = new MyAnimation(
      ENEMY.sprite_sheet,
      0,
      1200,
      400,
    ...
    this.FORM_SCALE = 1.0;
    this.effect = new MyAnimation(
      AM.getAsset("./img/Others/hit_effect.png"),
      0,
      0,
      1024,
      1024,
  ...
  this.boundingbox = new BoundingBox(
    ...
    this.y + 20,
    3,
    this.attack_animation.frameHeight * 0.2
  );
...
EnemyUnit.prototype.update = function() {
  ...
  for (var i = 0; i < this.game.entities.length; i++) {
    ...
    if (
      ...
      entity.name === "redhp" &&
      (this.boundingbox.collide(entity.boundingbox1) ||
        this.boundingbox.collide(entity.boundingbox2) ||
        this.boundingbox.collide(entity.boundingbox3))
    ) {
  ...
  if (this.name === "TrollWarlord") {
    this.boundingbox = new BoundingBox(
      ...
      this.y + 150,
      3,
      this.attack_animation.frameHeight * 0.1
    );
    this.hp_bar = new EnemyHP(
      this.x + 150,
      this.y + 230,
      this.hp_scale * 3 -
        (this.hp - this.hp_current) * ((this.hp_scale * 3) / this.hp),
      15
    );
  } else {
    this.boundingbox = new BoundingBox(
    ...
    this.hp_bar = new EnemyHP(
      this.x + 30,
      this.y + 80,
      this.hp_scale - (this.hp - this.hp_current) * (this.hp_scale / this.hp),
      10
    );
  }
...
function Enemy_Generator(ENTITY_NAME) {
  ...
  if (ENTITY_NAME === "Orc") {
    ...
    enemy = {
      sprite_sheet: AM.getAsset(
        "./img/enemy_team/fallen_angel/fallen_angel.png"
      ),
      HP: 150 * MULTIPLY,
      DAMAGE: 20,
      SPEED: -25,
    ...
    enemy = {
      sprite_sheet: AM.getAsset(
        "./img/enemy_team/death_knight/death_knight.png"
      ),
      HP: 100 * MULTIPLY,
      DAMAGE: 15,
      SPEED: -50,
