...
function MeleeHero(game, unit, X, Y) {
	...
	this.boundingbox = new BoundingBox(this.x + HERO.boundingbox_xoffset, this.y + HERO.boundingbox_yoffset, HERO.boundingbox_width, this.attackAnimation.frameHeight * 0.1);
